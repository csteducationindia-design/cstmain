...
class FeeStructure(db.Model):
    ...
    course_id = db.Column(db.Integer, db.ForeignKey('course.id'), nullable=True) # Added
...
def calculate_fee_status(student_id):
    ...
    # Calculate based on Session and Courses
    if student.session_id:
        # 1. Session-based fees (General)
        ...
        # 2. Course-specific fees (Only if student enrolled in that course)
...
# --- OTHER APIS (Sessions, Courses, etc) ---
