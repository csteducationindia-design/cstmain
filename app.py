...
# Replace with the keys you copied in Step 1
WHATSAPP_TOKEN = "" 
PHONE_NUMBER_ID = "887310361128800" 
VERIFY_TOKEN = "cst_secure_123" # Keep this exact password, we need it in Step 3

# --- 1. WEBHOOK ROUTE (Connects Facebook to your Code) ---
@app.route('/webhook', methods=['GET', 'POST'])
def whatsapp_webhook():
    # VERIFICATION: Meta checks if this is your server
    ...
    # MESSAGE HANDLING: A student sent a message
    if request.method == 'POST':
        ...
        if data.get('entry') and data['entry'][0].get('changes') and \
           ...
           data['entry'][0]['changes'][0]['value'].get('messages'):
            ...
            reply = generate_bot_reply(phone_number, message_text)
...
# --- 2. THE BOT'S BRAIN (Logic) ---
def generate_bot_reply(phone, text):
    # This is where we will look up fees later. For now, a simple menu.
    if "hello" in text or "hi" in text:
        return "👋 Welcome to CST Institute Bot!\n\nType options:\n1. *Fees* (Check Pending Fees)\n2. *Result* (Get Exam Marks)\n3. *Address* (Institute Location)"
    
    elif "fees" in text:
        # TODO: Connect this to your 'fee_status' database table
        return "💰 Please login to the student portal to view detailed fees: https://cstai.in/student"
    
    elif "address" in text:
        return "📍 We are located at: CST Institute, Bhusawal, Jalgaon, Maharashtra."
        
    else:
        return "🤖 I didn't understand. Please type 'Hello' for the menu."
